...
const pages = [
  ...
  { name: "products", out: "products.html", data: { title: `Products | ${site.SITE.legalName}`, description: "Sentinel, CFO, Eden, and Ledger.", activeNav: "products", pageClass: "products" } },
  { name: "product-sentinel", out: "product-sentinel.html", data: { title: `Sentinel | ${site.SITE.legalName}`, description: site.PRODUCTS.sentinel.subhead, activeNav: "products", activeProduct: "sentinel", pageClass: "product product-sentinel" } },
